...
impl Lexer {
    pub fn new(input: String) -> Lexer {
        let reg = HashMap::from([
            ...
            (
                "+=",
                Token::new_op(OpKind::Add, OpFlags::ARITH | OpFlags::ASSIGN, 1),
            ),
            (
                "-=",
                Token::new_op(OpKind::Subtract, OpFlags::ARITH | OpFlags::ASSIGN, 1),
            ),
            (
                "/=",
                Token::new_op(OpKind::Divide, OpFlags::ARITH | OpFlags::ASSIGN, 1),
            ),
            (
                "*=",
                Token::new_op(OpKind::Multiply, OpFlags::ARITH | OpFlags::ASSIGN, 1),
            ),
            (
                "%=",
                Token::new_op(OpKind::Remainder, OpFlags::ARITH | OpFlags::ASSIGN, 1),
            ),
            (
                "|=",
                Token::new_op(OpKind::BitwiseOr, OpFlags::BITWISE | OpFlags::ASSIGN, 1),
            ),
            (
                "^=",
                Token::new_op(OpKind::BitwiseXor, OpFlags::BITWISE | OpFlags::ASSIGN, 1),
            ),
            (
                "&=",
                Token::new_op(OpKind::BitwiseAnd, OpFlags::BITWISE | OpFlags::ASSIGN, 1),
            ),
            (
                ">>=",
                Token::new_op(OpKind::LeftShift, OpFlags::BITWISE | OpFlags::ASSIGN, 1),
            ),
            (
                "<<=",
                Token::new_op(OpKind::RightShift, OpFlags::BITWISE | OpFlags::ASSIGN, 1),
            ),
