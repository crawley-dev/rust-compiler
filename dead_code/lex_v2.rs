...
pub enum TokenKind {
    ...
    // operators
    Add { flags: OpFlags, prec: u8 },
    Divide { flags: OpFlags, prec: u8 },
    Subtract { flags: OpFlags, prec: u8 },
    Multiply { flags: OpFlags, prec: u8 },
    Remainder { flags: OpFlags, prec: u8 },
    Equal { flags: OpFlags, prec: u8 },
    NotEqual { flags: OpFlags, prec: u8 },
    LessThan { flags: OpFlags, prec: u8 },
    LessEqual { flags: OpFlags, prec: u8 },
    GreaterThan { flags: OpFlags, prec: u8 },
    GreaterEqual { flags: OpFlags, prec: u8 },
    LogicalOr { flags: OpFlags, prec: u8 },
    LogicalNot { flags: OpFlags, prec: u8 },
    LogicalAnd { flags: OpFlags, prec: u8 },
